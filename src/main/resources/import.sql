...
INSERT INTO tb_department(name) VALUES ('Tecnologia');

INSERT INTO tb_user(department_id , name , email) VALUES(1 , 'Júlia'  , 'julia@email.com');
INSERT INTO tb_user(department_id , name , email) VALUES(1 , 'Soraia' , 'soraia@email.com');
